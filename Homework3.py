...
def find_face(video):
    ...
    # Сброс цвета и имени перед обработкой нового кадра
    name = "UNKNOWN"
    surname = ""
    color = (255, 255, 0)  # Желтый цвет по умолчанию
    ...
    for (x, y, w, h) in faces:
        ...
        if face_encodings:
            ...
            if match[0]:
                name = "Danil"
                surname = "Zabinskii"
                color = (0, 255, 0)  # Зеленый цвет при распознавании
            else:
                name = "UNKNOWN"
                surname = ""
                color = (0, 0, 255)  # Красный цвет для нераспознанных лиц
